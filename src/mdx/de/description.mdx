...
Entwickler von <Link href="#openSource" underline="none">Jest Runner</Link>, einer VSCode-Erweiterung zur Testausführung. ([Seit 2020](https://github.com/nrwl/nx/issues/3868) wird Jest Runner als empfohlene Erweiterung von [NX](https://nx.dev/) installiert.)
