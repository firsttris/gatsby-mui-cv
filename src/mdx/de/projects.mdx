...
<Chips mb="30px" mt="10px" skills="TypeScript,React,Cypress,MUI,React-Query,VS Code,React-Beautiful-Dnd,OpenAPI,NX,Leaflet,recharts,Jenkins"/>
</AvoidPageBreakInside>
...
<Chips mb="30px" mt="10px" skills="Azure Cloud,CRA,VS Code,Typescript,React,Redux,React-Testing-Library,React-Query,SWR,GraphQL,Jest,MUI,Cypress,Jira,X-Ray,Confluence,Gitlab,nginx,NX"/>
</AvoidPageBreakInside>
