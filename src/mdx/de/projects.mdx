...
<Chips mb="30px" mt="10px" skills="Azure Cloud,CRA,Vscode,Typescript,React,Redux,React-Testing-Library,GraphQL,Jest,MUI,Cypress,Jira,X-Ray,Confluence,Gitlab,nginx"/>
