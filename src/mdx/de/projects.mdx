...
- Aufsetzen eines NextJS Projekts
- Implementierung von responsiven Chat-Komponenten mit MaterialUI (MUI)
- Darstellung der Nachrichten über Chunks
...
## Klarsolar Konfigurator
#### 10/2020 - 12/2020 in Stuttgart/DE
Klarsolar GmbH über Pixelschupser GmbH

- Neuentwicklung des alten Konfigurators mit Angular 10
- Aufsetzen eines neuen Projekts mit Nx-Tools
- Entwicklung von Komponenten für den Konfigurator mit Angular 10
- Customizing von Angular Material Komponenten mit Tailwind CSS entsprechend dem Design
- Datenmigration des alten Konfigurators
- Integration eines GraphQL-Backends mit Apollo-Client
...
- Toolchain des Projekts refactored und aktualisiert (Webpack)
- Komponentenbasierte Entwicklung eingeführt
- Komponenten für Chatfunktionalität entwickelt
...
- PoC für die Migration ihrer Web-App von Angular 1.x zu React
- Erweitern eines Webpack-Jobs, um die Konfiguration zur Laufzeit dynamisch in das Frontend einzufügen
