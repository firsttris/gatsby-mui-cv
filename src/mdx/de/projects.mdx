...
import { PageBreakBefore } from '../../components/pageBreakBefore.tsx'
import { AvoidPageBreakInside } from '../../components/avoidPageBreakInside.tsx'
...
<Chips mb="30px" mt="10px" skills="TypeScript, Angular 17, Angular-Material, NX, Cypress, Jest, MongoDb, GraphQL, Apollo, Amazon ECS, MSAL (Microsoft Authenticator Library), Azure"/>
</AvoidPageBreakInside>
...
<Chips mb="30px" mt="10px" skills="Azure Cloud,CRA,VS Code,Typescript,React,Redux,React-Testing-Library,React-Query,SWR,GraphQL,Jest,MUI,Cypress,Jira,X-Ray,Confluence,Gitlab,nginx"/>
</AvoidPageBreakInside>
...
<Chips mb="30px" mt="10px" skills="TypeScript, Angular 10, Angular Material, Tailwind CSS, GraphQL, Apollo, GraphQL"/>
</AvoidPageBreakInside>
