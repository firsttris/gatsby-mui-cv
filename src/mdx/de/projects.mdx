...
CTREAM GmbH über freelancermap.de
#### 07/2023 - 08/2023 in Mainz/DE | Scrum | Remote
...
<Chips mb="30px" mt="10px" skills="TypeScript, React, NextJs, MUI, React-Query, VS Code, Styled-Components, WebSocket, Python, ChatGPT"/>

## Erstellung von Benutzeroberflächen im Bereich der Telekommunikationsüberwachung
ATIS® Systems GmbH über Solcom
#### 10/2022 - 06/2023 in Bad Homburg/DE | Kanban | Remote

- Erfolgreiches Aufsetzen eines React/TypeScript-Projekts unter Verwendung von NX-Tools für effiziente Entwicklung.
...
- Einrichtung eines Webpack API Proxys zur Umgehung der Same-Origin-Policy, um reibungslose Datenübertragung zu ermöglichen.
...
- Erfolgreiche Umsetzung von kundenspezifischen Features, um die Anforderungen des Kunden zu erfüllen.
...
<Chips mb="30px" mt="10px" skills="TypeScript,React,Cypress,MUI,React-Query,VS Code,React-Beautiful-Dnd,OpenAPI-Typescript-generator,NX-Tools,Leaflet,recharts"/>
<PageBreak/>

## Mitwirkung an der Entwicklung der Heidelberg Cement's HConnect Produktsuite
Heidelberg Cement ag über Etengo
#### 10/2020 - 12/2021 in Heidelberg/DE | Scrum | Remote
...
Klarsolar GmbH über Pixelschupser GmbH
#### 10/2020 - 12/2020 in Stuttgart/DE | Scrum | Remote

- Die Entwicklung des Konfigurators mit Angular 10 erfolgte unter Verwendung fortschrittlicher Technologien und bewährter Best Practices, um eine hochwertige Anwendung zu realisieren.
- Erfolgreiches Aufsetzen eines neuen Projekts unter Verwendung von Nx-Tools zur Verbesserung der Entwicklungsprozesse.
- Entwicklung von maßgeschneiderten Komponenten für den Konfigurator in Angular 10, um eine benutzerfreundliche Benutzeroberfläche zu gewährleisten.
...
- Erfolgreiche Datenmigration des alten Konfigurators, um vorhandene Informationen nahtlos in das neue System zu übertragen.
...
#### 01/2020 - 09/2020 in Bretten/DE | Kanban | Remote
...
- Definition neuer Dependency-Cruiser-Regeln zur Verbesserung der Codequalität und -struktur.
- Implementierung eines Ansatzes zur Integration einer PWA (Progressive Web App) in einen bestehenden Monolithen, um die Benutzererfahrung zu optimieren.
...
#### 08/2019 - 11/2019 in Göppingen/DE | Scrum | Remote
...
#### 08/2019 - 12/2019 in Karlsruhe/DE | Kanban | Remote
...
ETECTURE GmbH über xing
#### 10/2017 - 06/2019 in Karlsruhe/DE | Kanban | Remote
...
#### 05/2017 - 09/2017 in Karlsruhe/DE | Scrum | Remote
...
#### 01/2017 - 04/2017 in Munich/DE | Scrum | Remote
...
#### 03/2016 - 12/2016 in Karlsruhe/DE | Scrum | Remote
...
#### 01/2015 - 12/2015 in Baden-Baden/DE | Wasserfall | Remote
...
#### 09/2012 - 12/2014 in Karlsruhe/DE | Scrum | Remote
...
- Verwendung von Technologien wie jQuery Mobile, PhoneGap, Oracle ADF, SoapUI, REST, JavaScript, jQuery und mehr.
