...
### Klarios Monitoring Center ist als ganzheitliches TKÜ-System ein unerlässliches Instrument für Sicherheitsbehörden. Es ist die Lösung zur Aufzeichnung, Verarbeitung, Analyse und Archivierung von Sprach- und Datenkommunikation. Das System unterstützt die Aufklärung und Verhinderung von schweren Straftaten in der nationalen und internationalen Zusammenarbeit bereit.
...
### In Zusammenarbeit mit Gameforge, einem der größten Spiele-Publisher in Europa, entsteht eine neue Spieleplattform.
