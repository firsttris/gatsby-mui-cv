...
CTREAM GmbH via freelancermap.de
#### 07/2023 - 08/2023 in Mainz/DE

- Setting up a Next.js project and setting up the infrastructure.
...
<Chips mb="30px" mt="10px" skills="TypeScript, React, NextJs, MUI, React-Query, VS Code, Styled-Components, WebSocket, Python, ChatGPT4"/>

## Creation of user interfaces in the field of telecommunications surveillance
ATIS® Systems GmbH via Solcom
#### 10/2022 - 06/2023 in Bad Homburg/DE

- Successfully set up a React/TypeScript project using NX tools for efficient development.
...
- Set up a Webpack API proxy to bypass the same-origin policy to allow smooth data transfer.
...
- Successful implementation of custom features to meet the customer's requirements.
...
## Participation in the development of Heidelberg Cement's HConnect product suite
Heidelberg Cement ag via Etengo
...
Klarsolar GmbH via Pixelschupser GmbH
#### 10/2020 - 12/2020 in Stuttgart/DE

- The development of the configurator with Angular 10 was done using advanced technologies and proven best practices to realize a high-quality application.
- Successfully set up a new project using Nx tools to improve development processes.
- Development of custom made components for the configurator in Angular 10 to ensure user-friendly UI.
...
- Successful data migration of the old configurator to seamlessly transfer existing information to the new system.
...
- Definition of new dependency cruiser rules to improve code quality and structure.
- Implemented an approach to integrate a PWA (Progressive Web App) into an existing monolith to optimize the user experience.
...
## Further development of components for Teamviewer and Blizz.com chat
Teamviewer GmbH via Gulp
#### 08/2019 - 11/2019 in Goeppingen/DE
...
## Development of web applications for Daimler projects
ETECTURE GmbH
...
- OpenAPI integration and setup of SwaggerUI for our middleware to enable clear API documentation and communication.
- Set up a comprehensive Jest Snapshot test suite to ensure code quality and functionality.
- Implementation of JSON web token authentication in our middleware to ensure secure and authorized communication.
- Creation of Docker Compose YAML build scripts to efficiently manage containerization and deployment.
- Setup of Docker clusters with reverse proxy (Traefik) to improve the scalability and performance of our applications.
...
## Development of a launcher for a gaming platform
Gameforge GmbH via Gulp
...
## Backend development of a scheduling system
Termin App GmbH (Timify) via Etengo
...
## Development of a design library and Angular components
...
## Java 8 development in one of arvato's Java Enterprise applications for receivables management
...
- Using technologies such as jQuery Mobile, PhoneGap, Oracle ADF, SoapUI, REST, JavaScript, jQuery and more.
