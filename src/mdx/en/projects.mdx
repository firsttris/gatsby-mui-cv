...
## Used Technologies
<Chips mb="30px" mt="10px" skills="Azure Cloud,CRA,VS Code,Typescript,React,Redux,React-Testing-Library,Jest,Material-ui,Cypress,Jira,X-Ray,Confluence,Gitlab,nginx"/>
