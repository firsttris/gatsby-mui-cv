...
[VSCode-Jest-Runner](https://marketplace.visualstudio.com/items?itemName=firsttris.vscode-jest-runner) focuses specifically on running or debugging a specific test or test suite.
In contrast, [VSCode-Jest](https://marketplace.visualstudio.com/items?itemName=Orta.vscode-jest) runs your current test suite every time you change it.
<br></br>
Jest Runner - is the recommended extension for nrwl's NX-Tools with 896,604 installs and a 5-star rating in the Visual Studio Marketplace. It has 231 stars on GitHub, has 3 developers and 38 contributors.
